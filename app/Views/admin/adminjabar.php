    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1>Tingkat Penghunian Kamar di Jawa Barat</h1>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($jabar as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <form action="/adminjabar/<?= $item['id']; ?>" method="post"
                                            onsubmit="return confirm('Apakah Anda yakin?')">
                                            <input type="hidden" name="_method" value="DELETE" />
                                            <button type="submit"
                                                style="background: none; border: none; cursor: pointer;"><i
                                                    class="fas fa-trash-alt"></i></button>
                                            <a href="/adminjabar/<?= $item['id']; ?>/edit"><i class="fas fa-edit"></i></a>
                                        </form>
                                    </div>
                                </td>
                            </tr>
            ...
            <br />
            <div>
                <a href="adminjabar/new" class="btn btn-primary">Tambah Data</a>
            </div>
        </div>
    </div>
    <!-- Service End -->
