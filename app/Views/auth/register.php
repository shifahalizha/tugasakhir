    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1"><img class="img-fluid" src="/img/bg-head-02.jpg" alt="">
                <div class="card-body">
                    <h2 class="title">Register For Admin</h2>
                    <form action="/register" method="POST">
                    <div class="input-group">Name
                            <input class="input--style-1" type="text" name="name">
                        </div>
                        ...
                        <a class="btn btn-link" href="/login" style="color: black;">Already Have an Account</a>
                    </form>
                </div>
            </div>
        </div>
